...
class Assigner(nn.Module):
    def __init__(self, im_hw, anchor_num_per_level, topk=9):
        ...
        anchors_s = [update_anchor(anchor, 40, 40 * 1.27632319) for anchor in anchors_s] # modify anchor size for different train dataset
        anchors_m = [update_anchor(anchor, 60, 60 * 1.27632319) for anchor in anchors_m]
        anchors_l = [update_anchor(anchor, 120, 120 * 1.27632319) for anchor in anchors_l]
