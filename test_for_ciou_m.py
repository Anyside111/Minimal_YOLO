...
os.makedirs('test_ciou_m', exist_ok=True)
...
for epoch in range(1,31):
    ...
    torch.save(net.state_dict(), f'test_ciou_m/m_ciou_e_{epoch}_train_loss_{train_loss:.5f}_val_loss_{val_loss:.5f}_accuracy_{accuracy:.5f}.pth')
...
file_path = 'test_ciou_m/stat_data_ciou_m.txt'
